        ...
        <div className="bg-white text-black rounded-lg w-full ">
          <div className="flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl">
                ...
                <div className="flex flex-row flex-wrap max-md:justify-center gap-y-2 gap-6 items-center text-gray-600 mt-2">
                  <span className="flex items-center gap-1">
                    <img
                      ...
                      alt=""
                      className="h-12 w-12 bg-white rounded-lg p-4 mr-4 max-md:mb-4 border"
                    />
            ...
            <div className="flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center ">
              <button className="bg-blue-600 p-2.5 px-100 text-white rounded">
                Apply Now
              </button>
              ...
              {jobs
                ...
                .filter((job) => {
                  if (typeof job.companyId === "string") {
                    ...
                    return job.companyId._id === JobData.companyId._id;
                  }
                  return false;
                })
                .slice(0, 4)
